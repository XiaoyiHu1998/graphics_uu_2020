...
void ObjectStorage_2D::init(){
    lightVector = {
            Light_2D(sf::Vector2f(600, 375), sf::Vector3f(0.2, 0.4, 0.7), 5),
            // Light_2D(sf::Vector2f(600, 250), sf::Vector3f(0.7, 0.4, 0.3), 5),
            // Light_2D(sf::Vector2f(600, 150), sf::Vector3f(0.1, 0.2, 0.1), 5),
            Light_2D(sf::Vector2f(600, 50), sf::Vector3f(0.2, 0.5, 0.4), 5)
    };
